...
<div class="left-content">
	   ...
	   <div class="mother-grid-inner">
		...
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Beranda</a> <i class="fa fa-angle-right"></i> <a href="#">Latihan</a> <i class="fa fa-angle-right"></i> <a href="exercise.php">Latihan Soal</a>  <i class="fa fa-angle-right"></i>Entity Relationship Diagram (Part 2)</li>
            </ol>
<!--four-grids here-->
