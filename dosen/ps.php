...
<div class="left-content">
	   ...
	   <div class="mother-grid-inner">
		...
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="dashboard.html">Beranda</a> <i class="fa fa-angle-right"></i> <a href="#">Soal dan Studi Kasus</a> <i class="fa fa-angle-right"></i> Studi Kasus</li>
            </ol>
<!--four-grids here-->
