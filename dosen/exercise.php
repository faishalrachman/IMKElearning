...
<div class="left-content">
	   ...
	   <div class="mother-grid-inner">
		...
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="dashboard.html">Beranda</a> <i class="fa fa-angle-right"></i> <a href="#">Soal dan Studi Kasus</a> <i class="fa fa-angle-right"></i> Latihan Soal</li>
            </ol>
<!--four-grids here-->
			...
			<div class="col-lg-12">
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td>
							<a href="../ex1.php" role="button" class="btn btn-info" title="Lihat soal latihan"> <i class="fa fa-pencil" aria-hidden="true"></i> </a>
					...
					<tr>
						...
						<td>
							<a href="../ex2.php" role="button" class="btn btn-info" title="Lihat soal latihan"> <i class="fa fa-pencil" aria-hidden="true"></i> </a>
