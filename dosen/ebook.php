...
<div class="left-content">
	   ...
	   <div class="mother-grid-inner">
		...
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="dashboard.html">Beranda</a> <i class="fa fa-angle-right"></i> <a href="#">Materi</a> <i class="fa fa-angle-right"></i>e-Book/slide</li>
            </ol>
<!--four-grids here-->
		   <p class="summary">e-Book / Slide</p>
		<div class="row four-grids grid-form1">
		<div class="add"><a href="#" role="button" class ="btn btn-primary pull-right">Tambah Materi</a></div>
			<div class="col-lg-12">
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td>
							<a href="#" role="button" class="btn btn-danger" title="Download Ebook"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> </a>
							<a href="#" role="button" class="btn btn-primary" title="Download Slide"><i class="fa fa-slideshare" aria-hidden="true"></i></a>
  ...
  <!--//content-inner-->
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
                  ...
                  <?php include '../menu//sidedosen.php'?>
							  </div>
							  <div class="clearfix"></div>		
							</div>
							<script>
