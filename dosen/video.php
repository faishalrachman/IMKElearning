...
<div class="left-content">
	   ...
	   <div class="mother-grid-inner">
		...
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.html">Home</a> <i class="fa fa-angle-right"></i> <a href="#">Materi</a> <i class="fa fa-angle-right"></i>Video</li>
            </ol>
<!--four-grids here-->
		   <p class="summary">Video</p>
			...
			<div class="col-lg-12">
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td>
							<a href="er1.php" role="button" class="btn btn-danger" title="Play"> <i class="fa fa-youtube-play" aria-hidden="true"></i> </a>
					...
					<tr>
						...
						<td>
							<a href="er2.php" role="button" class="btn btn-danger" title="Play"> <i class="fa fa-youtube-play" aria-hidden="true"></i> </a>
