...
<div class="left-content">
	   ...
	   <div class="mother-grid-inner">
		...
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.html">Home</a> <i class="fa fa-angle-right"></i> <a href="#">Materi</a> <i class="fa fa-angle-right"></i> <a href="video.php">Video</a>  <i class="fa fa-angle-right"></i>Entity Relationship Diagram (Part 1)</li>
            </ol>
<!--four-grids here-->
		...
		<div class="row four-grids">
			<div class="col-lg-8 col-md-offset-3">
				<video class="pidio" controls>
				  <source src="video/ERD_1.MP4" type="video/mp4">
